      ...
      <div>
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-xs font-bold text-[#2f261f] leading-tight">{sector.name}</h4>
              <span className="text-[10px] font-medium text-[#7a6d63]">{sector.cpseList?.join(', ')}</span>
            </div>
          </div>
        ...
        <div className="flex justify-between items-end mb-2">
          <span className="font-mono text-xs text-[#6d625c]">{formatNumber(sector.materials)} Materials</span>
          <span className="text-xs text-[#2f261f] font-bold">{sector.standardization}% Standardized</span>
        </div>
