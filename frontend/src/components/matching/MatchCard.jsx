    ...
    <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-2xs space-y-4 hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 text-xs">
          <div className="flex items-center justify-between mb-1.5">
            <span
              className={`text-[10px] font-bold px-2 py-0.5 rounded border ${srcBadge}`}
            >
              {sourceMaterial.cpse}
            </span>
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 text-xs">
          <div className="flex items-center justify-between mb-1.5">
            <span
              className={`text-[10px] font-bold px-2 py-0.5 rounded border ${tgtBadge}`}
            >
              {targetMaterial.cpse}
            </span>
            <span className="font-mono font-bold text-blue-600">
      ...
      <div className="flex items-center justify-between pt-2 border-t border-slate-100">
        <Button
          ...
          size="sm"
          icon={GitCompare}
          onClick={() => onCompare(sourceMaterial.code, targetMaterial.code)}
        >
